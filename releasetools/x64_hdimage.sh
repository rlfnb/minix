...
: ${ARCH=amd64}
: ${OBJ=../obj.${ARCH}}
: ${TOOLCHAIN_TRIPLET=i586-elf64-minix-}
: ${BUILDSH=build.sh}
: ${BUILDVARS=-V MKPAE=yes}
...
menu=Start latest MINIX 3:load_mods /boot/minix_latest/mod*; multiboot /boot/minix_latest/kernel rootdevname=c0d0p0 console=tty00 consdev=com0
...
echo "qemu-system-i386 -L . -bios OVMF-i32.fd -m 256M -drive file=${IMG},if=ide,format=raw"
